                    ...
                    <Card className="p-6 bg-white border-amber-100">
                        <p className="leading-relaxed text-gray-700">
                            {locale === 'ko'
                                ...
                                : 'DearMyKids helps every child visually experience their infinite possibilities. By seeing themselves as astronauts, doctors, or stars on stage, children are inspired to dream bigger. We aim to give wings to children\'s imaginations through AI technology.'}
                        </p>
                    </Card>
                </section>
                            ...
                            <li className="flex gap-3">
                                ...
                                <span className="text-gray-700">
                                    {locale === 'ko'
                                        ...
                                        : 'Uploaded original photos are permanently deleted from our servers within 24 hours of generation. Please download or save your generated results if you wish to keep them.'}
                                </span>
                            </li>
                            <li className="flex gap-3">
                                <span className="font-bold text-green-700 min-w-[4rem]">
                                ...
                                <span className="text-gray-700">
                                    {locale === 'ko'
                                        ...
                                        : 'User images are NEVER used to train our AI models. They are used temporarily and legally only for the purpose of generating the portrait you requested.'}
                                </span>
                            </li>
                        </ul>
                    </Card>
                        ...
                        <div className="space-y-4 text-sm text-gray-700">
                            <p>
                                {locale === 'ko'
                                    ...
                                    : '1. This service uses AI to generate images. The accuracy and quality of the results depend on the quality of the original photo and are not guaranteed to be perfect every time.'}
                            </p>
                            <p>
                                {locale === 'ko'
                                    ? '2. 생성된 이미지의 일부 디테일(손가락, 배경 텍스트 등)이 자연스럽지 않을 수 있습니다.'
                                    : '2. Some details in the generated images (fingers, background text, etc.) may appear unnatural due to the nature of AI generation.'}
                            </p>
                            <p>
                                {locale === 'ko'
                                    ? '3. 본 서비스는 오락 및 교육 목적으로 제공됩니다. 생성된 이미지를 상업적으로 이용하거나 타인의 명예를 훼손하는 용도로 사용하여 발생하는 문제에 대해 회사는 책임지지 않습니다.'
                                    : '3. This service is provided for entertainment and educational purposes. The company is not responsible for any issues arising from the commercial use of generated images or use that defames others.'}
                            </p>
                        </div>
                    </Card>
                </section>
